...
# note: 
- **to all those who think the website is ai slop, i just want to say that i have put a lot of effort into this project and tried not to use ai for any work except for some minor code snippets and stuff but the overall project is done by me.
